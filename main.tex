...
A station architecture based on phased arrays coherently sums the signals from multiple antennas using formed beams. Multiple beams are formed using time delays pointing in 
...
\begin{figure}[tbhp]
\begin{center}
\includegraphics[width=0.6\textwidth]{figures/beacon_EFSensitivity_5years_100stations}
\caption{Expected sensitivity of BEACON using the reference design described in the text compared with models of cosmogenic neutrinos, one assuming a high maximum energy in the accelerators (SFR1, p or mixed)\cite{Kotera2011a} and one assuming a mixed composition and a lower cutoff energy~\cite{Romero-Wolf2018}, as well as extensions to the power law fits of the astrophysical flux observed at lower energies (\cite{IceCube2015}, \cite{IceCube2016a}).}
